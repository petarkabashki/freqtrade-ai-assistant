...
class AssetPairInputNode(Node):
    ...
    def _get_user_input(self, last_inputs, validation_error_message=None):
        field_name = 'asset_pair'
        if validation_error_message:
            print(f"\n{AssetPairInputNode.ORANGE_COLOR_CODE}Validation Error:{AssetPairInputNode.RESET_COLOR_CODE} {validation_error_message}")
    ...
    def exec(self, prep_res, shared):
        ...
        while True:
            ...
            if validation_status == 'validate_success':
                ...
                print(f"Asset Pair cannot be empty. Please enter or 'q' to quit.")
    ...
    def post(self, shared, prep_res, exec_res):
        ...
        return 'validate_asset_pair' # Action to trigger validation node
