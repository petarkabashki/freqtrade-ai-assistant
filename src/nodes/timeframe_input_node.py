...
class TimeframeInputNode(Node):
    ...
    def _get_user_input(self, last_inputs, validation_error_message=None):
        ...
        if validation_error_message:
            print(f"\n{TimeframeInputNode.ORANGE_COLOR_CODE}Validation Error:{TimeframeInputNode.RESET_COLOR_CODE} {validation_error_message}")
    ...
    def exec(self, prep_res, shared):
        ...
        while True:
            ...
            if validation_status == 'validate_success':
                ...
                print(f"Timeframe cannot be empty. Please enter or 'q' to quit.")
    ...
    def post(self, shared, prep_res, exec_res):
        ...
        return 'validate_timeframe' # Action to trigger validation node
